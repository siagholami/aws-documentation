...
.. meta::
   :description: Programing Identity and Access Management using the AWS SDK for PHP version 3.
...
.. image:: images/code-samples-iam.png
   :alt: Diagram that provides an overview of how AWS SDK for PHP version 3 connects to Amazon Identity & Access Management  
