 ...
 *
 */
// snippet-start:[elastictranscoder.php.list_jobs_pipeline.complete] 
// snippet-start:[elastictranscoder.php.list_jobs_pipeline.import] 
...
// snippet-end:[elastictranscoder.php.list_jobs_pipeline.import]  
...
// snippet-start:[elastictranscoder.php.list_jobs_pipeline.main] 
...
// snippet-end:[elastictranscoder.php.list_jobs_pipeline.main]
// snippet-end:[elastictranscoder.php.list_jobs_pipeline.complete]
// snippet-comment:[These are tags for the AWS doc team's sample catalog. Do not remove.]
// snippet-sourcedescription:[List_Jobs.php demonstrates how to list an jobs.]
// snippet-keyword:[PHP]
// snippet-sourcesyntax:[php]
// snippet-keyword:[AWS SDK for PHP v3]
// snippet-keyword:[listJobsByPipeline]
