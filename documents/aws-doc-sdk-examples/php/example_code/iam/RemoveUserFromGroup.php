...
try {
    $result = $client->removeUserFromGroup(array(
...
// snippet-sourcedescription:[RemoveUserFromGroup.php demonstrates how to remove the specified user from the specified group. ]
// snippet-keyword:[PHP]
