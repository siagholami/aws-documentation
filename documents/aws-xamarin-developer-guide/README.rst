...
This repository contains source content for the official `AWS SDK for Xamarin Developer Guide`_. The
source code for the `AWS SDK for Xamarin`_ is also on GitHub, at https://github.com/aws/aws-sdk-xamarin.
...
.. _`aws sdk for xamarin developer guide`: http://docs.aws.amazon.com/mobile/sdkforxamarin/developerguide/
.. _`aws sdk for xamarin`: http://aws.amazon.com/mobile/sdk/
...
.. _issues: https://github.com/awsdocs/aws-xamarin-developer-guide/issues
