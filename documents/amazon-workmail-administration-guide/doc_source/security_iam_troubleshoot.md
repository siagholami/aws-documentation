# Troubleshooting Amazon WorkMail identity and access<a name="security_iam_troubleshoot"></a>
...
+ [I'm an administrator and want to allow others to access Amazon WorkMail](#security_iam_troubleshoot-admin-delegate)
+ [I want to allow people outside of my AWS sccount to access my Amazon WorkMail resources](#security_iam_troubleshoot-cross-account-access)

## I am not authorized to perform an action in Amazon WorkMail<a name="security_iam_troubleshoot-no-permissions"></a>
...
## I want to allow people outside of my AWS sccount to access my Amazon WorkMail resources<a name="security_iam_troubleshoot-cross-account-access"></a>
