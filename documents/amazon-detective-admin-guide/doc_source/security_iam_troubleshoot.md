# Troubleshooting Amazon Detective identity and access<a name="security_iam_troubleshoot"></a>
...
## I am not authorized to perform an action in Detective<a name="security_iam_troubleshoot-no-permissions"></a>
...
## I'm an administrator and want to allow others to access Detective<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I want to allow people outside of my AWS account to access my Detective resources<a name="security_iam_troubleshoot-cross-account-access"></a>
