# Security Best Practices for Kinesis Video Streams with WebRTC<a name="kvswebrtc-security-best-practices"></a>
...
For more information, see [Logging Kinesis Video Streams with WebRTC API Calls with AWS CloudTrail](kvswebrtc-monitoring-ct.md)\.