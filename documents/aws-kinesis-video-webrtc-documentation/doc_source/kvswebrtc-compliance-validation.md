# Compliance Validation for Kinesis Video Streams with WebRTC<a name="kvswebrtc-compliance-validation"></a>
...
+ [AWS Config](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config.html) – This AWS service that assesses how well your resource configurations comply with internal practices, industry guidelines, and regulations
