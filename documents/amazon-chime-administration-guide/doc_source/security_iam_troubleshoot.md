# Troubleshooting Amazon Chime identity and access<a name="security_iam_troubleshoot"></a>
...
+ [I'm an administrator and want to allow others to access Amazon Chime](#security_iam_troubleshoot-admin-delegate)
...
```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: chime:GetDomain
```
...
## I'm an administrator and want to allow others to access Amazon Chime<a name="security_iam_troubleshoot-admin-delegate"></a>
