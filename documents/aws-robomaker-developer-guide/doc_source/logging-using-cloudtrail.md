# Logging AWS RoboMaker API Calls with AWS CloudTrail<a name="logging-using-cloudtrail"></a>
...
## AWS RoboMaker Information in CloudTrail<a name="robomaker-info-in-cloudtrail"></a>
...
All AWS RoboMaker actions are logged by CloudTrail and are documented in the [AWS RoboMaker API Reference](https://docs.aws.amazon.com/robomaker/latest/dg/API_Reference.html)\. For example, calls to the `CreateSimulationJob`, `RegisterRobot` and `UpdateRobotApplication` actions generate entries in the CloudTrail log files\. 
...
## Understanding AWS RoboMaker Log File Entries<a name="understanding-robomaker-entries"></a>
