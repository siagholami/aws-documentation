# Amazon Lumberyard Release Notes: Known Issues in 1.23 (February 2020)

Lumberyard Beta 1.23 has the following known issues. Choose a topic area to learn more.

**Topics**
+ [3D Studio Max Tools and Plugin](#studio-max-tools-and-plugin-known-issues-v1.23)
+ [Android](#android-known-issues-v1.23)
+ [Android Studio](#android-studio-known-issues-v1.23)
+ [Animation Editor](#animation-editor-known-issues-v1.23)
+ [Area Objects and Triggers](#area-objects-and-triggers-known-issues-v1.23)
+ [Asset Builder API](#asset-builder-api-known-issues-v1.23)
+ [Asset Pipeline](#asset-pipeline-known-issues-v1.23)
+ [Audio](#audio-known-issues-v1.23)
+ [Cloud Canvas](#cloud-canvas-known-issues-v1.23)
+ [Cloud Gems](#cloud-gems-known-issues-v1.23)
+ [Cloud Gem Portal](#cloud-gem-portal-known-issues-v1.23)
+ [Component Entity System](#component-entity-system-known-issues-v1.23)
+ [Console Variables](#console-variables-known-issues-v1.23)
+ [CryEngineNonRCModule](#CryEngineNonRCModule-known-issues-v1.23)
+ [CryEntity](#cryentity-known-issues-v1.23)
+ [Data Types](#data-types-known-issues-v1.23)
+ [Decal Component](#decal-component-known-issues-v1.23)
+ [Dedicated Server](#dedicated-server-known-issues-v1.23)
+ [DirectX 12](#directx-12-known-issues-v1.23)
+ [EMFX](#emfx-known-issues-v1.23)
+ [Environment Probe Resources](#environment-probe-resources-known-issues-v1.23)
+ [FBX Settings](#fbx-known-issues-v1.23)
+ [Flow Graph](#flow-graph-known-issues-v1.23)
+ [Game Mode Functionality](#game-mode-functionality-known-issues-v1.23)
+ [Game Projects](#game-project-creation-known-issues-v1.23)
+ [Gems](#gems-known-issues-v1.23)
+ [Gloss Maps](#gloss-maps-known-issues-v1.23)
+ [Graphics](#graphics-known-issues-v1.23)
+ [High DPI Display Support](#high-dpi-display-support-known-issues-v1.23)
+ [Incredibuild](#incredibuild-known-issues-v1.23)
+ [Installation Paths](#installation-paths-known-issues-v1.23)
+ [iOS](#iOS-known-issues-v1.23)
+ [Launcher Projects](#launcher-projects-known-issues-v1.23)
+ [Lens Flare Elements](#lens-flare-elements-known-issues-v1.23)
+ [Linux](#linux-known-issues-v1.23)
+ [Lmbr.exe](#lmbr.exe-known-issues-v1.23)
+ [Lumberyard Editor](#lumberyard-editor-known-issues-v1.23)
+ [Lumberyard Installation](#lumberyard-installation-known-issues-v1.23)
+ [Lumberyard Setup Assistant](#lumberyard-setup-assistant-known-issues-v1.23)
+ [Lmbr.exe](#lmbr-exe-known-issues-v1.23)
+ [Lmbr\_test.cmd Tool](#lmbr_test.cmd-tool-known-issues-v1.23)
+ [Lyzard.exe](#lyzard.exe-known-issues-v1.23)
+ [macOS](#macOS-known-issues-v1.23)
+ [Material Browser](#material-browser-known-issues-v1.23)
+ [Material Editor](#material-editor-known-issues-v1.23)
+ [Maya](#maya-known-issues-v1.23)
+ [Mobile](#mobile-known-issues-v1.23)
+ [Multiplayer Sample](#multiplayer-sample-known-issues-v1.23)
+ [NVIDIA Cloth](#nvidia-cloth-known-issues-v1.23)
+ [Particle Editor](#particle-editor-known-issues-v1.23)
+ [Perforce Source Control](#perforce-source-control-known-issues-v1.23)
+ [Physics (Legacy)](#physics-known-issues-v1.23)
+ [PhysX](#physx-known-issues-v1.23)
+ [Project Configurator](#project-configurator-known-issues-v1.23)
+ [Resource Compiler](#resource-compiler-known-issues-v1.23)
+ [SamplesProject](#samples-project-known-issues-v1.23)
+ [Script Canvas](#script-canvas-known-issues-v1.23)
+ [Slices](#slices-known-issues-v1.23)
+ [Starter Game](#starter-game-known-issues-v1.23)
+ [Static Mesh Component](#static-mesh-component-known-issues-v1.23)
+ [Substance Editor](#substance-editor-known-issues-v1.23)
+ [Terrain Texture Data](#terrain-texture-data-known-issues-v1.23)
+ [Terrain Texture Dimensions](#terrain-texture-dimensions-known-issues-v1.23)
+ [Track View](#track-view-known-issues-v1.23)
+ [Trigger Area Component](#trigger-area-component-known-issues-v1.23)
+ [Twitch ChatPlay and Twitch JoinIn](#twitch-chatplay-and-joinin-known-issues-v1.23)
+ [UI Canvases](#ui-canvases-known-issues-v1.23)
+ [Virtual Reality](#virtual-reality-known-issues-v1.23)
+ [Visual Studio Support](#visual-studio-support-known-issues-v1.23)
+ [Waf Build System](#waf-build-system-known-issues-v1.23)
+ [Windows Environment Variables](#windows-environment-variables-known-issues-v1.23)
+ [Miscellaneous](#miscellaneous-known-issues-v1.23)

## 3D Studio Max Tools and Plugin<a name="studio-max-tools-and-plugin-known-issues-v1.23"></a>
...
## Android<a name="android-known-issues-v1.23"></a>
...
+ NDK 20 is not yet supported. This will be addressed in an upcoming release.

## Android Studio<a name="android-studio-known-issues-v1.23"></a>
...
## Animation Editor<a name="animation-editor-known-issues-v1.23"></a>
...
## Area Objects and Triggers<a name="area-objects-and-triggers-known-issues-v1.23"></a>
...
## Asset Builder API<a name="asset-builder-api-known-issues-v1.23"></a>
...
## Asset Pipeline<a name="asset-pipeline-known-issues-v1.23"></a>
...
## Audio<a name="audio-known-issues-v1.23"></a>
...
## Cloud Canvas<a name="cloud-canvas-known-issues-v1.23"></a>
...
## Cloud Gems<a name="cloud-gems-known-issues-v1.23"></a>
...
## Cloud Gem Portal<a name="cloud-gem-portal-known-issues-v1.23"></a>
...
## Component Entity System<a name="component-entity-system-known-issues-v1.23"></a>
...
## Console Variables<a name="console-variables-known-issues-v1.23"></a>
...
## CryEngineNonRCModule<a name="CryEngineNonRCModule-known-issues-v1.23"></a>
...
## CryEntity<a name="cryentity-known-issues-v1.23"></a>
...
## Data Types<a name="data-types-known-issues-v1.23"></a>

The `.cga` and `.anm` data types are deprecated.

## Decal Component<a name="decal-component-known-issues-v1.23"></a>
...
## Dedicated Server<a name="dedicated-server-known-issues-v1.23"></a>
...
## DirectX 12<a name="directx-12-known-issues-v1.23"></a>
...
## EMotion FX (EMFX)<a name="emfx-known-issues-v1.23"></a>

**Introduced in v1.23**: If you enable the EMotionFX Gem on Linux, you must install libxmu to run the Linux Dedicated Server. Use the following command to install libxmu:

```
apt install libxmu6
```

## Environment Probe Resources<a name="environment-probe-resources-known-issues-v1.23"></a>
...
## FBX Settings<a name="fbx-known-issues-v1.23"></a>
...
## Flow Graph<a name="flow-graph-known-issues-v1.23"></a>
...
## Game Mode Functionality<a name="game-mode-functionality-known-issues-v1.23"></a>
...
## Game Projects<a name="game-project-creation-known-issues-v1.23"></a>
...
## Gems<a name="gems-known-issues-v1.23"></a>
...
## Gloss Maps<a name="gloss-maps-known-issues-v1.23"></a>
...
## Graphics<a name="graphics-known-issues-v1.23"></a>
...
## GridMate<a name="gridmate-known-issues-v1.23"></a>
...
## High DPI Display Support<a name="high-dpi-display-support-known-issues-v1.23"></a>
...
## Incredibuild<a name="incredibuild-known-issues-v1.23"></a>
...
## Installation Paths<a name="installation-paths-known-issues-v1.23"></a>
...
## iOS<a name="iOS-known-issues-v1.23"></a>
...
## Launcher Projects<a name="launcher-projects-known-issues-v1.23"></a>

Unified cross-platform client and server launcher projects have been added in Lumberyard version 1.23. In a future release, these projects will replace the existing platform-specific launcher projects. For more information, see [Launcher Projects](lumberyard-v1.23.md#lumberyardv1.23-highlights-launcher-projects) in the Highlights section.

## Lens Flare Elements<a name="lens-flare-elements-known-issues-v1.23"></a>
...
## Linux<a name="linux-known-issues-v1.23"></a>
...
## Lmbr.exe<a name="lmbr.exe-known-issues-v1.23"></a>
...
## Lumberyard Editor<a name="lumberyard-editor-known-issues-v1.23"></a>
...
## Lumberyard Installation<a name="lumberyard-installation-known-issues-v1.23"></a>
...
## Lumberyard Setup Assistant<a name="lumberyard-setup-assistant-known-issues-v1.23"></a>
...
## Lmbr\_test.cmd Tool<a name="lmbr_test.cmd-tool-known-issues-v1.23"></a>
...
## Lyzard.exe<a name="lyzard.exe-known-issues-v1.23"></a>
...
## macOS<a name="macOS-known-issues-v1.23"></a>
...
## Material Browser<a name="material-browser-known-issues-v1.23"></a>
...
## Material Editor<a name="material-editor-known-issues-v1.23"></a>
...
## Maya<a name="maya-known-issues-v1.23"></a>
...
## Mobile<a name="mobile-known-issues-v1.23"></a>

Do not use spaces when you set the **whitelist** field in the `config.ini` file for the CrySCompileServer. This prevents validation of the IP address from working.

## Multiplayer Sample<a name="multiplayer-sample-known-issues-v1.23"></a>
...
## NVIDIA Cloth<a name="nvidia-cloth-known-issues-v1.23"></a>

**Introduced in v1.23++: We have added experimental support for NVIDIA Cloth physics. It currently has the following known issues:

+ NVIDIA Cloth Gem is only supported on Windows platforms at the moment. Other platforms (Mac and Linux) are untested.

+ Cloth Debug Visualization will not show when running from Launchers.

+ Cloth does not support LOD textures.

+ Cloth does not support scaled transforms.

## Particle Editor<a name="particle-editor-known-issues-v1.23"></a>
...
## Perforce Source Control<a name="perforce-source-control-known-issues-v1.23"></a>
...
## Physics (Legacy)<a name="physics-known-issues-v1.23"></a>
...
## PhysX<a name="physx-known-issues-v1.23"></a>
...
## Project Configurator<a name="project-configurator-known-issues-v1.23"></a>
...
## Resource Compiler<a name="resource-compiler-known-issues-v1.23"></a>
...
## SamplesProject<a name="samples-project-known-issues-v1.23"></a>
...
## Script Canvas<a name="script-canvas-known-issues-v1.23"></a>
...
## Slices<a name="slices-known-issues-v1.23"></a>
...
## Starter Game<a name="starter-game-known-issues-v1.23"></a>
...
## Static Mesh Component<a name="static-mesh-component-known-issues-v1.23"></a>

The **Affects Navmesh** check box for the **Static Mesh** component doesn't affect nav mesh generation.

## Substance Editor<a name="substance-editor-known-issues-v1.23"></a>
...
## Terrain Texture Data<a name="terrain-texture-data-known-issues-v1.23"></a>
...
## Terrain Texture Dimensions<a name="terrain-texture-dimensions-known-issues-v1.23"></a>
...
## Track View<a name="track-view-known-issues-v1.23"></a>
...
## Trigger Area Component<a name="trigger-area-component-known-issues-v1.23"></a>
...
## Twitch ChatPlay and Twitch JoinIn<a name="twitch-chatplay-and-joinin-known-issues-v1.23"></a>
...
## UI Canvases<a name="ui-canvases-known-issues-v1.23"></a>
...
## Virtual Reality<a name="virtual-reality-known-issues-v1.23"></a>
...
## Visual Studio Support<a name="visual-studio-support-known-issues-v1.23"></a>
...
## Waf Build System<a name="waf-build-system-known-issues-v1.23"></a>
...
## Windows Environment Variables<a name="windows-environment-variables-known-issues-v1.23"></a>
...
## Miscellaneous<a name="miscellaneous-known-issues-v1.23"></a>
