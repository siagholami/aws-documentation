# Identity and Access Management for AWS Elemental MediaTailor<a name="security-iam"></a>
...
This section provides background and additional information about the setup procedures you follow to use AWS Elemental MediaTailor\. See [Setting Up AWS Elemental MediaTailor](setting-up.md)\.
