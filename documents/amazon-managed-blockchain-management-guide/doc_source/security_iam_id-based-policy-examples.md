# Amazon Managed Blockchain Identity\-Based Policy Examples<a name="security_iam_id-based-policy-examples"></a>
...
+ [Performing All Managed Blockchain Actions on All Accessible Managed Blockchain Networks for an AWS Account](#security_iam_id-based-policy-examples-access-one-bucket)
...
## Performing All Managed Blockchain Actions on All Accessible Managed Blockchain Networks for an AWS Account<a name="security_iam_id-based-policy-examples-access-one-bucket"></a>
